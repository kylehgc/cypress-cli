---
description: 'Visual design reviewer using Claude Opus 4.6. Use when: reviewing site screenshots against the design spec. Invoked as subagent by review prompts.'
name: 'Review (Opus)'

...
| ---------------------------------------------- | ------------------------------------------------------------------------------------------ |
| [ARIA_SNAPSHOT_PORT.md](ARIA_SNAPSHOT_PORT.md) | Line-by-line plan for porting Playwright's aria snapshot code. What to keep, cut, and why. |
| [COMMANDS.md](COMMANDS.md)                     | Every CLI command, its schema, Cypress API mapping, and response format.                   |

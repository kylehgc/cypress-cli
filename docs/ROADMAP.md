...
1. **#43** Feasibility audit — gates P2/P3 decisions
2. **#47** Operational readiness — unblocks anyone trying to use it
3. **#44** SKILL file — primary integration surface
4. **#45** Snapshot-to-file — changes the output model
5. **#46** Inline codegen — changes response format

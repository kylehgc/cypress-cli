...
1. **#47** Operational readiness — unblocks anyone trying to use it
2. **#66** LLM validation — validate the tool works for its intended purpose before adding features
3. **#43** Feasibility audit — gates P2/P3 decisions
4. **#44** SKILL file — primary integration surface
5. **#45** Snapshot-to-file — changes the output model
6. **#46** Inline codegen — changes response format
